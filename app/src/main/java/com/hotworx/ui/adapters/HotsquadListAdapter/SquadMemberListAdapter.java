...
public class SquadMemberListAdapter extends RecyclerView.Adapter<SquadMemberListAdapter.ViewHolder> {
    private LayoutInflater inflater;
    private Context context;
    private List<SessionEnt> arrayList;
    private OnItemClickListener onItemClickListener;

    public SquadMemberListAdapter(Context context, List<SessionEnt> arrayList) {
