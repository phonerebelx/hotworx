...
public class PrivacyPolicyFragment extends BaseFragment {
    ...
    public void setTitleBar(TitleBar titleBar) {
        ...
        titleBar.setSubHeading(getString(R.string.privacy));
    }


    private void apiCallForHelp() {
        getServiceHelper().enqueueCall(getWebService().getPrivacyPolicy(ApiHeaderSingleton.apiHeader(requireContext())), WebServiceConstants.PrivacyPolicy, true);
    }

    @Override
    public void ResponseSuccess(String result, String Tag) {
        switch (Tag) {
            case WebServiceConstants.PrivacyPolicy:
